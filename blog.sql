...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 20 2020 г., 21:52
...
INSERT INTO `articles` (`id_articles`, `headpost`, `bodypost`, `id_user`, `date`, `id_category`, `tags`, `moderation`) VALUES
...
(22, 'фывфыв', 'фывфыв', 'admin', '20:10:2020 20:49:56', 'space', '', '0');
...
--
ALTER TABLE `articles`
  MODIFY `id_articles` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
