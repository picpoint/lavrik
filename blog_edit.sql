...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 06 2020 г., 20:18
...
INSERT INTO `articles` (`id_articles`, `headpost`, `bodypost`, `id_user`, `date`, `moderation`) VALUES
...
--
ALTER TABLE `articles`
  ADD CONSTRAINT `articles_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`login`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
